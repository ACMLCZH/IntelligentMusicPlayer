...
class LoginTestCase(TestCase):
    ...
    def test_login_success(self):
        ...
        self.assertEqual(
            response.json()["response"], "Log In Successful!"
        )  # check response
        self.assertTrue(response.json()["redirect"])  # check redirect
        self.assertEqual(
            response.json()["redirect_url"], reverse("index")
        )  # check redirect URL
    ...
    def test_login_invalid_credentials(self):
        ...
        self.assertEqual(response.status_code, 200)  # check state code
        self.assertEqual(
            response.json()["response"], "Invalid Username or Password"
        )  # check response
...
class SignUpTestCase(TestCase):
    ...
    def test_sign_up_success(self):
        ...
        self.assertEqual(response.status_code, 200)  # check state code
        self.assertEqual(
            response.json()["response"], "Sign Up Successful!"
        )  # check response
        self.assertTrue(response.json()["redirect"])  # check redirect
        self.assertEqual(
            response.json()["redirect_url"], reverse("login")
        )  # check redirect URL
    ...
    def test_sign_up_password_mismatch(self):
        ...
        self.assertEqual(response.status_code, 200)  # check state code
        self.assertEqual(
            response.json()["response"], "Passwords are not the same!"
        )  # check response
    ...
    def test_sign_up_username_exists(self):
        ...
        self.assertEqual(response.status_code, 200)  # check state code
        self.assertEqual(
            response.json()["response"], "Username already exists!"
        )  # check response
...
class ViewsTestCase(TestCase):
    ...
    def test_backend_login_process_sign_in_success(self):
        data = {"type": "sign_in", "username": "testuser", "password": "testpassword"}
        response = self.client.post(
            reverse("sign_in_sign_up_reset_request"),
    ...
    def test_backend_login_process_sign_in_failure(self):
        data = {"type": "sign_in", "username": "wronguser", "password": "wrongpassword"}
        response = self.client.post(
            reverse("sign_in_sign_up_reset_request"),
            data=json.dumps(data),
            content_type="application/json",
        ...
        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(
            response.content, {"response": "Invalid Username or Password"}
        )
    ...
    def test_backend_login_process_sign_up_password_mismatch(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(
            response.content, {"response": "Passwords are not the same!"}
        )
    ...
    def test_index_view_logged_in(self):
        ...
        self.assertEqual(
            response.context["current_track"],
            {
                "id": 0,
